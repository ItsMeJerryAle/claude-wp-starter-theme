 ...
 * ACF fields: events_eyebrow, events_heading, events_view_all_label/url,
 *             events_featured, events_sidebar_1/2, events_vol_*
 */
...
<section class="bg-white py-16">
    <div class="max-w-default mx-auto px-4">
        ...
        <!-- Top Row: Featured (70%) + Sidebar stack (30%) -->
            ...
            <div class="flex flex-col gap-6">
                <?php foreach ( array( $sidebar_1, $sidebar_2 ) as $idx => $event ) :
                    ...
                    <div data-animate data-delay="<?php echo $idx === 0 ? '0' : '150'; ?>"
                        ...
                        <?php if ( $event['link'] ) : ?>
                            <a href="<?php echo esc_url( $event['link'] ); ?>" aria-label="<?php echo esc_attr( $event['title'] ); ?>"
                               class="absolute bottom-5 right-5 w-10 h-10 bg-primary rounded-full flex items-center justify-center transition-all hover:brightness-110 hover:scale-105">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5" aria-hidden="true">
