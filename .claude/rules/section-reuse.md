...
|---------|-------------|---------|
| `hero-inner.php` | `heading`, `description`, `btn_text`, `btn_url` | `template-get-support.php` (and future inner pages) |
| `application-process.php` | `eyebrow`, `heading`, `btn_text`, `btn_url`, `steps`, `theme` (`light`\|`dark`) | `template-get-support.php`, `single-service-apply-for-funds.php` |
